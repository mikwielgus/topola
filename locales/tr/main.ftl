...
tr-menu-debug-show-navmesh = Navmesh'i Görüntüle
tr-menu-debug-show-bboxes = BBoxes'i Görüntüle
...
tr-menu-debug-update-timestep = Kare Zaman Adımı
...
tr-menu-route-options-squeeze-through-under-bends = Bantların Altından Sıkışarak Geç
