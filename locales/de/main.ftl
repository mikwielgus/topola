...
tr-menu-debug-show-ghosts = Zeige Geister
tr-menu-debug-step-rate = Schrittweite
tr-menu-debug-step-rate-unit = Schritte/s
tr-menu-route-options-multilayer-timeout = Mehrebenen-Maximallaufzeit
tr-menu-route-options-planar-timeout = planare Maximallaufzeit
